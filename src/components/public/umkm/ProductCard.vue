      ...
      <div class="mt-auto">
        <div class="flex flex-col gap-3">
          ...
          <div class="flex gap-2">
            <RouterLink
              :to="`/umkm/${product.id}`"
              class="flex-1 text-center text-[10px] font-black uppercase tracking-widest py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors"
            >
              Detail
            </RouterLink>
            ...
            <button
              type="button"
              class="flex-1 text-center text-[10px] font-black uppercase tracking-widest py-2.5 rounded-xl bg-orange-500 hover:bg-orange-600 text-white shadow-lg shadow-orange-200 dark:shadow-none transition-all active:scale-95"
