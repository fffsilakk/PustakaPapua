<template>
  ...
  >
    ...
    >
      ...
      <router-link to="/">
        <a
          class="flex items-center gap-2 font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white group transition-all duration-300 hover:scale-105"
          aria-label="Brand"
        >
          <!-- Logo Badge -->
          <div
  ...
  <Teleport to="body">
    ...
    >
      ...
      >
        ...
        >
          <h3 class="font-bold text-gray-800 dark:text-white">ナレDev</h3>
          <button
            @click="closeMobileMenu"
            type="button"
        ...
        <div class="p-2 space-y-1">
          ...
          <!-- Tutorial -->
          <router-link to="/Tutorial" @click="closeMobileMenu">
            <a
          ...
          <!-- Tentang -->
          <router-link to="/Tentang" @click="closeMobileMenu">
            <a
              class="p-3 flex items-center gap-3 text-sm text-gray-800 hover:bg-gray-100 hover:text-emerald-600 rounded-lg focus:outline-none transition-all duration-300 dark:text-neutral-200 dark:hover:bg-neutral-700 dark:hover:text-emerald-400"
            >
